...
function filterBookByPrice(books, minPrice) {
    return books.filter(function (books) { return books.price > minPrice && books.genre == 'fiction'; });
}
function discountBookPrice(books) {
...
var discountBook = discountBookPrice(filterBook);
